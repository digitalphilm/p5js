...
function Car(index, length_, horiz_, x_, y_) {
  this.index = index;
  this.l = length_;
  this.horiz = horiz_;
	var top; var right; var bottom; var left;
	var blockedTop; var blockedRight; var blockedBottom; var blockedLeft;
  var x1; var y1;
  this.x = x_*scl; this.y = y_*scl;
  this.offsetX = 0; this.offsetY = 0; 
  this.dragging = false; //are we dragging?
  this.hover = false; //are we hovering over this object?
  
	// detect if we're hovering over a "car", and set the flag if we are
